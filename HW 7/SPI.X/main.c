...
int main(void){
    ...
    while(1){
        ...
        for (i = 0; i<628; i++){
            ...
            unsigned short v1 = (short) j*(1023./628.0); // scale the wave: was getting very finicky at 1024 so changed to 1023
            if (sign == 1){
                j++;
            }
            else j--;
...
void initSPI() {
    ...
    SPI1BRG = 1.4; // 1000 for 24kHz, 1 for 12MHz; // baud rate to 10 MHz [SPI1BRG = (48000000/(2*desired))-1]
